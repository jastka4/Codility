...
public class FrogRiverOne {
     ...
     * Complexity: O(N).
     *
     * @param X the end position
     * @param A the array representing the falling leaves
     * @return the earliest time when leaves appear in every position across the river
     */
